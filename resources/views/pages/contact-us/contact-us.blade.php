...
@section('content')
    <main class="main__content_wrapper">
        ...
        <section class="contact__section section--padding">
            <div class="container">
                <div class="section__heading text-center mb-40">
                    <span class="section__heading--subtitle">{{ $contactContent['subtitle'] ?? 'Contact With Us' }}</span>
                    <h2 class="section__heading--maintitle">{{ $contactContent['main_title'] ?? 'Get In Touch' }}</h2>
                </div>
                <div class="main__contact--area position__relative">

                    <div class="contact__form">
                        <h3 class="contact__form--title mb-40">{{ $contactContent['form_title'] ?? 'Contact Us' }}</h3>
                    ...
                    <div class="contact__info border-radius-5">
                        {{-- Phone Numbers --}}
                        @php
                            $phone1 = $contactContent['phone_1'] ?? '+01234-567890';
                            $phone2 = $contactContent['phone_2'] ?? '+01234-5688765';
                        @endphp
                        <div class="contact__info--items">
                            <h3 class="contact__info--content__title text-white mb-15">
                                {{ $contactContent['phone_title'] ?? 'Contact Us' }}</h3>
                            <div class="contact__info--items__inner d-flex">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">
                                        @if (!empty($contactContent['phone_subtitle']))
                                            {{ $contactContent['phone_subtitle'] }}<br>
                                        @endif
                                        @if ($phone1)
                                            <a
                                                href="tel:{{ preg_replace('/[^0-9+]/', '', $phone1) }}">{{ $phone1 }}</a>
                                        @endif
                                        @if ($phone2)
                                            <br><a
                                                href="tel:{{ preg_replace('/[^0-9+]/', '', $phone2) }}">{{ $phone2 }}</a>
                                        @endif
                                    </p>
                                </div>
                            </div>
                        ...
                        {{-- Email Addresses --}}
                        @php
                            $email1 = $contactContent['email_1'] ?? 'info@example.com';
                            $email2 = $contactContent['email_2'] ?? 'support@example.com';
                        @endphp
                        <div class="contact__info--items">
                            <h3 class="contact__info--content__title text-white mb-15">
                                {{ $contactContent['email_title'] ?? 'Email Address' }}</h3>
                            <div class="contact__info--items__inner d-flex">
                                <div class="contact__info--icon">
                        ...
                        <div class="contact__info--items">
                            <h3 class="contact__info--content__title text-white mb-15">
                                {{ $contactContent['office_title'] ?? 'Office Location' }}</h3>
                            <div class="contact__info--items__inner d-flex">
                                <div class="contact__info--icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="31.57" height="31.13"
                                        viewBox="0 0 31.57 31.13">
                                ...
                                <div class="contact__info--content">
                                    <p class="contact__info--content__desc text-white">
                                        {{ $contactContent['office_address'] ?? '123 Street New York City, United States Of America NY 750065.' }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="contact__info--items">
                            ...
                            <ul class="contact__info--social d-flex">
                                @if (!empty($contactContent['facebook_url']))
                                ...
                                @endif
                                @if (!empty($contactContent['twitter_url']))
                                    <li class="contact__info--social__list">
                                        <a class="contact__info--social__icon" target="_blank"
                                            href="{{ $contactContent['twitter_url'] }}">
                                ...
                                @endif
                                @if (!empty($contactContent['instagram_url']))
                                    <li class="contact__info--social__list">
                                        <a class="contact__info--social__icon" target="_blank"
                                ...
                                @endif
                                @if (!empty($contactContent['youtube_url']))
                                    <li class="contact__info--social__list">
                                        <a class="contact__info--social__icon" target="_blank"
                                            href="{{ $contactContent['youtube_url'] }}">
        ...
        @php
            $mapIframeUrl =
                $contactContent['map_iframe_url'] ??
                'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7887.465355142307!2d-0.13384360843222626!3d51.4876034467734!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48760532743b90e1%3A0x790260718555a20c!2sU.S.%20Embassy%2C%20London!5e0!3m2!1sen!2sbd!4v1632035375945!5m2!1sen!2sbd';
        @endphp
        @if ($mapIframeUrl)
            <div class="contact__map--area section--padding pt-0">
                <iframe class="contact__map--iframe" src="{{ $mapIframeUrl }}" style="border:0;" allowfullscreen=""
                    loading="lazy"></iframe>
            </div>
        @endif
