    ...
    public static function getSectionConfig(string $section): array
    {
        $configs = [
            'hero_slider' => [
                ...
                'image_size'   => '1521 × 515 px',
                'has_meta'     => false,
                'fields'       => [
                    'image'        => ['label' => 'Slide Background Image (1521 × 515 px)', 'type' => 'image', 'required' => true, 'recommended_size' => '1521 × 515 px'],
            ...
            'best_selling' => [
                ...
                'fields'       => [
                    'image'           => ['label' => 'Primary Image (278 × 278 px)', 'type' => 'image', 'required' => true, 'recommended_size' => '278 × 278 px'],
                    'secondary_image' => ['label' => 'Hover / Secondary Image (278 × 278 px)', 'type' => 'image', 'required' => false, 'recommended_size' => '278 × 278 px'],
