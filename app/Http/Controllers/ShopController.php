...
class ShopController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Search by keyword if provided (name, sku, descriptions, category)
    ...
    /**
     * Display a listing of Best Selling products, matching shop-left-sidebar layout.
     */
    public function bestSelling(Request $request)
    {
        ...
        $query = Product::active()->bestSelling()->with(['category', 'images']);
        ...
        switch ($sort) {
            ...
            case 'latest':
            default:
                $query->orderBy('best_selling_order', 'asc')->orderBy('created_at', 'desc');
                break;
        }
        ...
        // Active categories with counts of active best-selling products
        $categories = Category::active()
            ->withCount(['products' => function ($q) {
                $q->where('is_active', true)->where('is_best_selling', true);
            }])
            ->orderBy('sort_order', 'asc')
            ->orderBy('name', 'asc')
            ->get();

        return view('pages.best-selling.best-selling', compact(
            'products',
            'categories',
            'currentCategory',
            'categorySlug',
